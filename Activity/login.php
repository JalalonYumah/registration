	...
	<table>
		<tbody>
			<tr>
				...
				<td><input type="text" name="emailusername" required="" class="form-control" /></td>
			</tr>
			<tr>
				<th>Password:</th>
			...
			<tr>
				<td></td>
				<td><input onclick="return(submitlogin());" type="submit" name="submit" value="Login" class="btn btn-info" /></td>
			</tr>
			<tr>
				<td></td>
